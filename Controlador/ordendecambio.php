<?php
    ...
    require_once("latexGenerator.php");
                        ...
                        { 
                            if(isset($_GET['id']))
                            {
                              ...
                              //  $ruta ="../Repositorio/asesor";
                                 $ruta = "../test";
                                chdir($ruta);
                                $rutaD="../Repositorio/".$nombreUGE."/OC/";
                                ...
                                $texto = str_replace('[[observaciones]]', genMultipleEnumeration($obs), $texto);
                                ...
                                if (strcasecmp($nombreDoc, $nombDoc)!=0) 
                                {
                                   ...
                                   registrar_correccion($args, $conexion, $docs); //new
