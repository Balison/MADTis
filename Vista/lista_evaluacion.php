                                ...
                                <table class="table form-group">      
                                    ...
                                    <tbody>                                                    
                                        ...
                                        while ($fila = mysql_fetch_array($peticion)) {
                                            if (!empty($fila[0])) {
                                                    $codigo = $fila['ID_R'];
                                                    $actividad = $fila['NOMBRE_R'];
                                                    $nombreU = $fila['NOMBRE_U'];
                                                ...
                                                while ($fechaActividad = mysql_fetch_array($peticion1)) {
                                                    $fechaFin = $fechaActividad["FECHA_FR"];
                                                }

                                                $peticion2 = $conexion->consulta("SELECT MAX(ID_R) FROM registro WHERE `NOMBRE_R`= '$actividad' and `NOMBRE_U`='$nombreU'");
                                                while ($maxID = mysql_fetch_array($peticion2))
                                                { 
                                                    $IDPago = $maxID["MAX(ID_R)"];
                                                } 
                                                $peticion3 = $conexion->consulta("SELECT `NOMBRE_E` FROM evaluacionElemento where `NOMBRE_E`='$actividad' and
                                                    `ID_PAGO`='$IDPago'");
                                                ...
                                                $peticion3 = $conexion->consulta("SELECT grupo_empresa.NOMBRE_LARGO_GE FROM grupo_empresa, registro WHERE registro.ID_R='$codigo' and grupo_empresa.NOMBRE_U=registro.NOMBRE_U");
                                                while ($consulGE = mysql_fetch_array($peticion3)) {
                                                    $nLargoGE = $consulGE["NOMBRE_LARGO_GE"];
                                                }
