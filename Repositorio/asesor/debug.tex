...
\newcommand{\sistema}[0]{Implantacion SAETIS}
\newcommand{\convocatoria}[0]{CPETIS2015}
\newcommand{\fecha}[0]{2015/05/27}

%% datos de la empresa con la que se hace el contrato

\newcommand{\empresa}[0]{\textbf{MAD}}
\newcommand{\empresaL}[0]{\textbf{MAD SOFTWARE S.R.L.}}
\newcommand{\representante}[0]{Juan Manuel Castro Arnez}

%% nombre del asesor

%\newcommand{\asesor}[0]{Maria Leticia Blanco Coca}
...
Juan Manuel Castro Arnez \hspace*{20mm} Maria Leticia Blanco Coca \\
